                                    ...
                                    while ($db_field2 = mysqli_fetch_array($result2)) {
                                       $id =$db_field2["id"];
                                        ...
                                        ?>  
                                           ...
                                           <td><a style="color:blue;" href="../avatarwebsite/portfolio_files/<?php echo $db_field2["portfolio_file"] ?>" target="_blank"> Portfolio File Link</a> </td>
                                           ...
                                           <td><a style="color:blue;" href="<?php echo $db_field2["portfolio_link"] ?>" target="_blank"> Click Here To View</a> </td>
                                            ...
                                            <tr class="white-space-no-wrap">
                                            <td>Resume Link </td>
                                           <td><a style="color:blue;"  href="../avatarwebsite/resume_files/<?php echo $db_field2["resume_file"] ?>" target="_blank"> Click Here To View </a> </td>
