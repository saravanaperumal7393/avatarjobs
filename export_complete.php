...
$sql = "SELECT id, clientname, job, members, notes, completion, time_comp, reference, entry_date, assigned_by, job_status, close_time, cus_date FROM jobcreate Where  job_status ='Closed Completed'"; // Replace 'your_table' with your actual table name
$result = $db->query($sql);
