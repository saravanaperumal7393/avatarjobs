...
$sql = "SELECT entry_date, clientname, job, members, notes, completion, time_comp, assigned_by, job_status, close_time FROM jobcreate Where job_status ='Closed Completed' AND completion BETWEEN '$start_date' AND '$end_date'"; // Replace 'your_table' with your actual table name
