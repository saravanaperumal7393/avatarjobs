...
if ($result) {
    ...
    if (!empty($originalFileName)) {
        ...
        $sql = "UPDATE jobcreate SET clientname='$client', job='$job', members='$members', notes='$notes', job_type='$job_type', completion='$completion', start_time='$start_time', time_comp='$time_picker_end', reference='$fileLinks', reference_link='$reference_link', entry_date='$entry_date', assigned_by='$assigned_by', cus_date='$cus_date' WHERE id='$job_id'";
    ...
    //  echo "1111";
    //  exit;
        $sql = "UPDATE jobcreate SET clientname='$client', job='$job', members='$members', notes='$notes', job_type='$job_type', completion='$completion', start_time='$start_time',  time_comp='$time_picker_end', reference_link='$reference_link',  entry_date='$entry_date', assigned_by='$assigned_by', cus_date='$cus_date' WHERE id='$job_id'";
        // echo $sql;
        // exit;
        $result = mysqli_query($db, $sql);
