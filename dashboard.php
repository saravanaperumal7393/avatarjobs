                                        ...
                                        ?>  
                                            ...
                                            <td class="pr-0 ">
                                                ...
                                                <?php
                                                  if ($dateDifference < 0) {
                                                    // Past date
                                                    echo '<span style="color: red;">' . $db_field2['job'] . '<br>' . $db_field2['job_type'] .'<br>' . $db_field2['completion'] . '<br>' . $db_field2['start_time'].'-' . $db_field2['time_comp']. '</span>';
                                       ...
                                       <!-- <td> <?php echo $db_field2["cus_date"]?></td>                                                -->
                                               <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <form action="delete_job.php?Mahendran" method="post">
                                                        <input type="hidden" name="job_id" value="<?php echo $db_field2['id']; ?>">
                                                        <input type="hidden" name="Mahendran" value="Mahendran">
